...
class AuthorServiceImplTest {
    ...
    void shouldReturnExpectedAuthorList() {
        ...
        List<Author> actualBookList = authorRepository.findAll();
    ...
    void shouldCreateBook() {
        ...
        Mockito.verify(authorRepository, Mockito.times(1)).save(expectedAuthor);
    }
    ...
    void shouldReturnBookById() {
        ...
        Mockito.when(authorRepository.getById(expectedAuthor.getId())).thenReturn(expectedAuthor);
