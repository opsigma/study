...
class GenreServiceImplTest {
    ...
    void shouldReturnExpectedGenreList() {
        ...
        Mockito.when(genreRepositoryJpa.getAll()).thenReturn(expectedGenreList);
        List<Genre> actualBookList = genreRepositoryJpa.getAll();
    ...
    void shouldCreateBook() {
        ...
        Mockito.verify(genreRepositoryJpa, Mockito.times(1)).save(expectedGenre);
    }
    ...
    void shouldReturnBookById() {
        ...
        Mockito.when(genreRepositoryJpa.getById(expectedGenre.getId())).thenReturn(expectedGenre);
    ...
    void shouldDeleteBookById() {
        ...
        Mockito.verify(genreRepositoryJpa, Mockito.times(1)).deleteById(expectedGenre.getId());
    }
}