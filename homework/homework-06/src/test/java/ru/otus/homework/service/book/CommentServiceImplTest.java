...
class CommentServiceImplTest {
    ...
    void shouldReturnExpectedGenreList() {
        ...
        Mockito.when(commentRepositoryJpa.getAll()).thenReturn(expectedCommentList);
    ...
    void shouldCreateComment() {
        ...
        Mockito.verify(commentRepositoryJpa, Mockito.times(1)).save(expectedComment);
        Mockito.when(commentRepositoryJpa.save(expectedComment)).thenReturn(expectedComment);
    }
    ...
    void shouldReturnCommentById() {
        ...
        Mockito.when(commentRepositoryJpa.getById(expectedComment.getId())).thenReturn(expectedComment);
    ...
    void shouldDeleteCommentById() {
        ...
        Mockito.verify(commentRepositoryJpa, Mockito.times(1)).deleteById(expectedComment.getId());
    }
}