...
public class GenreDaoJdbc implements GenreDao {
    ...
    public long insert(Genre genre) {
        ...
        jdbcOperations.update("insert into genre (name) values ( :name)", map, keyHolder);
    ...
    public Genre getById(Long id) {
        ...
        return jdbcOperations.queryForObject(sql, Collections.singletonMap("id", id), new GenreMapper());
    }
    ...
    public void update(Genre genre) {
        ...
        jdbcOperations.update("update genre set name = :name where id = :id", map);
    }
